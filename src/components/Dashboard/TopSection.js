...
import {ArrowRight, FunnelSimple, Plus} from "phosphor-react";
            ...
            <div className={styles.countryList} style={{top: y, left: x, position: "fixed"}}>
                {currencyValues.map((item) => (
                    <div className={styles.countryItem} onClick={() => {
                        ...
                        <img src={`http://purecatamphetamine.github.io/country-flag-icons/3x2/${item.contry_short}.svg`}
                             className={styles.flag} alt=""/>
        ...
        <>
            ...
            <div className={styles.top_section}>
                ...
                <div className={styles.top_section_left}>
                    ...
                    <button className={styles.cont_pick} onClick={(e) => toggleDropdown(e)}><FunnelSimple size={14}
                                                                                                          weight="thin"/>
                        <img
                ...
                <div className={styles.top_section_right}>
                    <Button type={"secondary"} onClick={() => setShowAddModal(true)}><Plus size={14}/> Add
                        Money</Button>
                    <Button type={"primary"} onClick={() => setShowSendModal(true)}><ArrowRight size={14}/> Send
                        Money</Button>
                </div>
            </div>
        </>
